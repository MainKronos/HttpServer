...
int main(int argc, char* argv[]) {
	...
	if(http_server_add_handler(&server, "/test", test_callback, NULL)) return -1;
	...
	if(http_server_add_handler(&server, "/test/8.0", test8_callback, NULL)) return -1;
	if(http_server_add_handler(&server, "/test/8.1", test8_callback, NULL)) return -1;
	if(http_server_add_handler(&server, "/test/8.2", test8_callback, NULL)) return -1;
	if(http_server_add_handler(&server, "/test/8.3", test8_callback, NULL)) return -1;
	if(http_server_add_handler(&server, "/test/8.4", test8_callback, NULL)) return -1;
	if(http_server_add_handler(&server, "/test/8.5", test8_callback, NULL)) return -1;
	if(http_server_add_handler(&server, "/test/8.6", test8_callback, NULL)) return -1;
	if(http_server_add_handler(&server, "/test/8.7", test8_callback, NULL)) return -1;
	if(http_server_add_handler(&server, "/test/8.8", test8_callback, NULL)) return -1;
	if(http_server_add_handler(&server, "/test/8.9", test8_callback, NULL)) return -1;
